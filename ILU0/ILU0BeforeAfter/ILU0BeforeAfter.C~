...
namespace Foam
{
    defineTypeNameAndDebug(ILU0BeforeAfter, 0);

    lduPreconditioner::
        addasymMatrixConstructorToTable<ILU0BeforeAfter>
        addILU0BeforeAfterditionerAsymMatrixConstructorToTable_;
}


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void Foam::ILU0BeforeAfter::calcPreconDiag()
{
...
Foam::ILU0BeforeAfter::ILU0BeforeAfter
(
...
void Foam::ILU0BeforeAfter::precondition
(
    scalarField& x,
    const scalarField& b,
...
) const
{
    if (matrix_.symmetric())
    {
        FatalErrorIn
        (
            "void ILU0BeforeAfter::precondition\n"
            "(\n"
            "    scalarField& x,\n"
            "    const scalarField& b,\n"
            "    const direction cmpt\n"
            ") const"
        )   << "Calling ILU0BeforeAfter on a symetric matrix.  "
...
void Foam::ILU0BeforeAfter::preconditionT
(
    scalarField& x,
    const scalarField& b,
    const direction cmpt
